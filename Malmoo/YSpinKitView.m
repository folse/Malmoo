...
-(id)initWithStyle:(YSpinKitViewStyle)style {
    return [self initWithStyle:style color:[UIColor whiteColor]];
}
    ...
    if (self) {
        ...
        if (style == YSpinKitViewStylePlane) {
            ...
            for (NSInteger i = 0; i < 3; i += 1) {
                ...
                circle.frame = CGRectMake(8, -45, 20, 20);
                ...
                anim.repeatCount = HUGE_VALF;
                anim.duration = 8.0;
                anim.beginTime = beginTime - (0.8 * i);
                anim.keyTimes = @[@(0.0),@(0.5),@(1.0)];
                ...
                anim.values = @[
                    ...
                    [NSValue valueWithCATransform3D:CATransform3DMakeScale(6.0, 6.0, 0.0)],
            ...
            NSTimeInterval beginTime = CACurrentMediaTime();
            CGFloat cubeSize = floor(CGRectGetWidth(self.bounds) / 2.2);
            CGFloat widthMinusCubeSize = CGRectGetWidth(self.bounds) - cubeSize + 5;
